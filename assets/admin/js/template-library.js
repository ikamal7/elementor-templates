...
(function ($, elementor, ha) {
	...
	Library.Views.EmptyTemplateCollection = Marionette.ItemView.extend({
		...
		modesStrings: {
			empty: {
				...
				message: 'templatesEmptyMessage',
			},
			noResults: {
				title: 'templatesNoResultsTitle',
				message: 'templatesNoResultsMessage',
			},
		},
	...
	Library.Manager = function () {
		var modal,
			...
			$openLibraryButton = '<div class="elementor-add-section-area-button elementor-add-ha-button"> <i class=""></i> </div>',
